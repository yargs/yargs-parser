...
export type ArrayOption = string | {
    key: string;
    boolean?: boolean;
    string?: boolean;
    number?: boolean;
...
export type ConfigCallback = (configPath: string) => {
    [key: string]: any;
} | Error;
...
export type Flag = ValueOf<Omit<Flags, 'keys'>>;
export type FlagValue = ValueOf<Flag>;
export type FlagsKey = KeyOf<Omit<Flags, 'keys'>>;
export type ArrayFlagsKey = Extract<FlagsKey, 'bools' | 'strings' | 'numbers'>;
export declare enum DefaultValuesForTypeKey {
    BOOLEAN = "boolean",
    STRING = "string",
    NUMBER = "number",
    ARRAY = "array"
